...
func setupDiffHandler(t *testing.T, pypiURL string) (*chi.Mux, func()) {
	t.Helper()
...
func TestDiffHandler_Get_PackageNotFound(t *testing.T) {
	...
	defer pypiSrv.Close()
	r, cleanup := setupDiffHandler(t, pypiSrv.URL)
	defer cleanup()
