    ...
    <div class="mx-auto flex h-14 max-w-6xl items-center gap-6 px-4">
      ...
      <form class="flex-1" @submit.prevent="onSearch">
        <div class="relative max-w-md">
          <svg class="pointer-events-none absolute left-2.5 top-1/2 size-4 -translate-y-1/2 text-zinc-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <nav class="flex items-center gap-4">
        ...
        >
          <svg v-if="colorMode.value === 'dark'" class="size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
